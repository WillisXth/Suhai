...
smd({ cmdname: "restart", info: "To restart bot",type: "tools",fromMe: true, filename: __filename }, 
    async(message) => {

   await message.reply('Restarting'); 
   try{ require('pm2').restart('index.js'); }catch(e){await message.reply('_ERROR!_'); console.log(e)}
